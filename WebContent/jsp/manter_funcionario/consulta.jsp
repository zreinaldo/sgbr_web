...
<fieldset>
				<table>
					<tr>
						...
						<td><input type="text" id="nomeCliente" name="cliente" maxlength="58"></td>
					</tr>
					<tr>
						<td colspan="2" id="botoes">
						<input type="button" value="Consultar"
								onclick="submeterFormulario('<%=PRManterFuncionario.NM_SERVLET%>','<%=PRManterFuncionario.EVENTO_PROCESSAR_CONSULTA%>')"
								id="consultar">
						
						<input type="button" value="Pesquisar" onclick="submeterFormulario(PRManterFuncionario,processarFiltroConsulta)">
							 <input type="button" value="Novo"OnClick="">
							<input type="button" value="Home" onClick=""></td>
					</tr>
				</table>
