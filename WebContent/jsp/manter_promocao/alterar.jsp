	...
	<FORM name="form_principal" method="post" action="">
		...
		<fieldset>
			<table>
				...
				<tr>
					<td><label for="cdPromocao">Código Promoção:</label></td>
					<td><input type="text" readonly="readonly"
						id="<%=PRManterPromocao.ID_REQ_ATR_cdPromocao%>"
						name="<%=PRManterPromocao.ID_REQ_ATR_cdPromocao%>" value="<%=promocao.getCdPromocao()%>"
						maxlength="58"></td>
				</tr>
				<tr>
