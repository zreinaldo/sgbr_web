...
public class PRManterConta extends PRConsultar {
	...
	public void exibirAbrirContaComanda(HttpServletRequest pRequest, HttpServletResponse pResponse) throws Exception {
	...
	public void exibirAbrirContaMesa(HttpServletRequest pRequest, HttpServletResponse pResponse) throws Exception {
	...
	public void processarAbrirConta(HttpServletRequest pRequest, HttpServletResponse pResponse) throws Exception {
	...
	public void exibirEncerrarConta(HttpServletRequest pRequest, HttpServletResponse pResponse) throws Exception {
		...
		conta = this.aFachadaSGBR.getInstancia().consultaContaPorChavePrimaria(conta);

		pRequest.setAttribute(this.ID_REQ_ATR_cdComanda,
				conta.getCdComanda() == null ? "" : conta.getCdComanda().toString());
	...
	public void exibirContaParcial(HttpServletRequest pRequest, HttpServletResponse pResponse) throws Exception {
	...
	public void processarEncerrarConta(HttpServletRequest pRequest, HttpServletResponse pResponse) throws Exception {

		String cdConta = this.getAtributoOuParametroStringOpcional(this.ID_REQ_ATR_cdConta, pRequest);
		String vlDinheiroDesconto = this.getAtributoOuParametroStringOpcional(this.ID_REQ_ATR_vlDinheiroDesconto,
				pRequest);
	...
	public void atualizarDescontoConta(HttpServletRequest pRequest, HttpServletResponse pResponse) throws Exception {
